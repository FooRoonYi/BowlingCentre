...
public class MarketingBowling extends JFrame {
	...
	public MarketingBowling() {
		...
		lblNewLabel.setIcon(new ImageIcon(MarketingBowling.class.getResource("/insAsg3/12.jpg")));
		lblNewLabel.setBounds(659, 399, 307, 295);
		panel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon(MarketingBowling.class.getResource("/insAsg3/3.jpg")));
