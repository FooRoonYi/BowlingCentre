...
public class EmployeeRegistrationBowling extends JFrame {
	...
	public EmployeeRegistrationBowling() {
		...
		lblNewLabel.setIcon(new ImageIcon(EmployeeRegistrationBowling.class.getResource("/insAsg3/2735734-200.png")));
		...
		btnUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
				File file = new File("C:\\Users\\User\\eclipse-workspace\\P2 Project\\src\\insAsg3\\EmployeeInfoSystem.txt");
				if(!file.exists()) {
					file.createNewFile();
					}
		...
		lblNewLabel_2.setIcon(new ImageIcon(EmployeeRegistrationBowling.class.getResource("/insAsg3/bigstock_bowling_strike_icon_realistic_253910683.jpg")));
