...
public class UserOptionBowling extends JFrame {
	...
	public UserOptionBowling() {
		...
		lblAdmin.setIcon(new ImageIcon(UserOptionBowling.class.getResource("/insAsg3/admin-settings-male.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(UserOptionBowling.class.getResource("/insAsg3/gender-neutral-user.png")));
