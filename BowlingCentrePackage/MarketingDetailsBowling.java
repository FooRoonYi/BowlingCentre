...
public class MarketingDetailsBowling extends JFrame {
	...
	public MarketingDetailsBowling() {
		...
		lblNewLabel.setIcon(new ImageIcon(MarketingDetailsBowling.class.getResource("/insAsg3/ballandpins.jpg")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(MarketingDetailsBowling.class.getResource("/insAsg3/five-white-bowling-pins-260nw-285728342.jpg")));
		...
		lblNewLabel_3.setIcon(new ImageIcon(MarketingDetailsBowling.class.getResource("/insAsg3/candlepin-bowling.jpg")));
